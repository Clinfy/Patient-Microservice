...
import { BaseServiceException, ServiceExceptionResponse } from 'src/common/exceptions/base-service.exception';
...
export class AllExceptionsFilter implements ExceptionFilter {
  constructor(
    ...
    if (exception instanceof BaseServiceException) {
      ...
      const exceptionResponse = exception.getResponse() as Partial<ServiceExceptionResponse>;
